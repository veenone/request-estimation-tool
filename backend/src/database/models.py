...
class TaskTemplate(Base):
    ...
    is_pr_fix: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False, server_default="0")
    description: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    product_type: Mapped[Optional[str]] = mapped_column(String, nullable=True)
...
class Estimation(Base):
    ...
    elapsed_hours: Mapped[float] = mapped_column(Float, default=0, server_default="0")
    elapsed_days: Mapped[float] = mapped_column(Float, default=0, server_default="0")
    elapsed_weeks: Mapped[float] = mapped_column(Float, default=0, server_default="0")
