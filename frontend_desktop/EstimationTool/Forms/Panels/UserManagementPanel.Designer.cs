...
partial class UserManagementPanel
{
    ...
    private void InitializeComponent()
    {
        ...
        _btnAdd    = new Button { Text = "Add User", Width = 100, Height = 38, Location = new Point(0,   7) };
        ...
        _grid.Columns.Add(new DataGridViewTextBoxColumn { Name = "Username",    HeaderText = "Username",     FillWeight = 20 });
        _grid.Columns.Add(new DataGridViewTextBoxColumn { Name = "DisplayName", HeaderText = "Display Name", FillWeight = 22 });
        _grid.Columns.Add(new DataGridViewTextBoxColumn { Name = "Email",       HeaderText = "Email",        FillWeight = 22 });
        _grid.Columns.Add(new DataGridViewTextBoxColumn { Name = "Role",        HeaderText = "Role",         FillWeight = 12 });
        _grid.Columns.Add(new DataGridViewTextBoxColumn { Name = "IsActive",    HeaderText = "Active",       FillWeight = 8  });
        _grid.Columns.Add(new DataGridViewTextBoxColumn { Name = "LastLogin",   HeaderText = "Last Login",   FillWeight = 18 });
